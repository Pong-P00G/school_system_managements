              ...
              <td class="px-6 py-3.5 text-right">
                <div class="flex justify-end gap-1">
                  <button @click="openAssignmentModal('edit', asn)"
                    class="w-8 h-8 rounded-lg bg-transparent border-none text-ink-muted text-base flex items-center justify-center cursor-pointer transition-all hover:bg-info/8 hover:text-info">
                    <Icons name="mdi-pencil" />
                  </button>
                  <button @click="handleDeleteAssignment(asn.assignment_id)"
                    class="w-8 h-8 rounded-lg bg-transparent border-none text-ink-muted text-base flex items-center justify-center cursor-pointer transition-all hover:bg-error/8 hover:text-error">
      ...
      <div class="bg-surface rounded-2xl shadow-modal w-full max-w-130 overflow-hidden animate-fade-in">
        <div class="flex items-center justify-between px-6 py-5 border-b border-border-light bg-page">
          ...
          <button @click="showAssignmentModal = false"
            class="w-8 h-8 rounded-lg bg-transparent border-none text-ink-muted text-base flex items-center justify-center cursor-pointer hover:bg-primary/5">
        ...
        <div class="flex items-center justify-end gap-3 px-6 py-4 border-t border-border-light bg-page">
          <button type="button" @click="showAssignmentModal = false"
            class="inline-flex items-center px-4 py-2 bg-transparent text-primary border-[1.5px] border-border-medium rounded-xl font-sans text-sm font-medium cursor-pointer transition-all hover:border-primary hover:bg-primary/5">Cancel</button>
